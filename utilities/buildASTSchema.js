...
function buildASTSchema(ast, options) {
  ...
  return new _schema.GraphQLSchema({
    ...
    mutation: operationTypes.mutation ? definitionBuilder.buildObjectType(operationTypes.mutation) : null,
    subscription: operationTypes.subscription ? definitionBuilder.buildObjectType(operationTypes.subscription) : null,
    types: types,
...
var ASTDefinitionBuilder = exports.ASTDefinitionBuilder = function () {
  ...
  ASTDefinitionBuilder.prototype._makeImplementedInterfaces = function _makeImplementedInterfaces(def) {
    ...
    return def.interfaces && def.interfaces.map(function (iface) {
      return _this3.buildInterfaceType(iface);
    });
  };
  ...
  ASTDefinitionBuilder.prototype._makeInputObjectDef = function _makeInputObjectDef(def) {
    ...
    return new _definition.GraphQLInputObjectType({
      ...
      description: getDescription(def, this._options),
      fields: function fields() {
        return _this8._makeInputValues(def.fields);
      },
      astNode: def
    });
  };
