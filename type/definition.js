...
var GraphQLScalarType = exports.GraphQLScalarType = function () {
  ...
  GraphQLScalarType.prototype.isValidValue = function isValidValue(value) {
    return !(0, _isInvalid2.default)(this.parseValue(value));
  };
  ...
  GraphQLScalarType.prototype.isValidLiteral = function isValidLiteral(valueNode, variables) {
    return !(0, _isInvalid2.default)(this.parseLiteral(valueNode, variables));
  };
...
var GraphQLEnumType /* <T> */ = exports.GraphQLEnumType = function () {
  ...
  GraphQLEnumType.prototype.isValidLiteral = function isValidLiteral(valueNode, _variables) {
